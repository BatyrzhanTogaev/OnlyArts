...
class ArtworkListView(ListView):
    model = Artwork
    template_name = 'home.html'  # Используемый шаблон
    context_object_name = 'artworks'
    paginate_by = 10  # Пагинация на 10 работ
...
class ArtworkCreateView(LoginRequiredMixin, CreateView):
    ...
    success_url = reverse_lazy('home')  # После загрузки возвращаемся на главную страницу
...
class ArtworkDetailView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        paginator = Paginator(comments_list, 5)  # Пагинация по 5 комментариев на страницу
    ...
    def post(self, request, *args, **kwargs):
        ...
        # В случае ошибки, возвращаем контекст с формой и сообщениями об ошибках
